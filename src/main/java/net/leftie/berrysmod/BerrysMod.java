...
public class BerrysMod implements ModInitializer {
	...
	public static final Item GOLDEN_PIE = new Item(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(8).saturationModifier(4.5F).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 120), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.NIGHT_VISION, 900), 1.0F).build()));
	...
	//TODO try to get the jams in FoodStuffs tab
